...
[![status](https://img.shields.io/badge/status-v0.3.0-brightgreen)](https://github.com/arahe-dev/fairy)
...
> **Status.** FairySDK **v0.3.0** is implemented: `Survey(ctx, url)`,
...
v0.3.0 — implemented and race-clean (`go test -race ./...`), release
